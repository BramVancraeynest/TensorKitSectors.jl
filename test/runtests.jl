...
const sectorlist = (
    ...
    TambaraYamagami{1, 1}, TambaraYamagami{1, -1},
    TambaraYamagami{2, 1}, TambaraYamagami{2, -1},
    TambaraYamagami{4, 1}, TambaraYamagami{4, -1},
    TambaraYamagami{7, 1}, TambaraYamagami{8, -1},
    TambaraYamagami{67, 1}, TambaraYamagami{128, 1},
    TambaraYamagami{3, -1} ⊠ TambaraYamagami{2, -1}, TambaraYamagami{2, 1} ⊠ Z3Irrep,
    TambaraYamagami{3, -1} ⊠ FibonacciAnyon, TambaraYamagami{5, -1} ⊠ IsingAnyon,
    TambaraYamagami{64, 1} ⊠ Z4Irrep, TambaraYamagami{128, -1} ⊠ SU2Irrep,
